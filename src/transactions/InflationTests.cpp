...
TEST_CASE("inflation", "[tx][inflation]")
{
    ...
    SECTION("total coins")
    {
        ...
        // 10^18 total coins
        // ONFO - hard coded
        REQUIRE(getTotalCoins() == 2000000000000000000);
        ...
        REQUIRE(getFeePool() == 1000000020); /* ONFO (3*txFee) - 1*/
        REQUIRE(getTotalCoins() == 2000000000000000000); /* ONFO */
        ...
        REQUIRE(getFeePool() == 1000000034); /* ONFO (5*txFee) - 1*/
        REQUIRE(getTotalCoins() == 2000000000000000000); /* ONFO */
...
// ONFO            REQUIRE(clh.feePool == 9536050500000022); /* ONFO */
// ONFO            REQUIRE(clh.totalCoins == 1019072100000000000);
//             REQUIRE(getFeePool() == 95361000000301);
...
//            REQUIRE(beforeInflationTarget2 == 6357366866666667);
