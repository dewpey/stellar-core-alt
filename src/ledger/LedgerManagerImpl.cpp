...
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_FEE = 7; /* ONFO - Anything below 7 and payments tests start failing */ 
const uint32_t LedgerManager::GENESIS_LEDGER_BASE_RESERVE = 10000000;
const uint32_t LedgerManager::GENESIS_LEDGER_MAX_TX_SIZE = 100;
const int64_t LedgerManager::GENESIS_LEDGER_TOTAL_COINS = 2000000000000000000; /* ONFO */
